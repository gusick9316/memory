...
class MemoriesManager {
    ...
    async handleSubmit() {
        ...
        const title = formData.get('memory-title').trim();
        const author = formData.get('memory-author').trim();
        const year = parseInt(formData.get('memory-year'));
        const month = parseInt(formData.get('memory-month'));
        const day = parseInt(formData.get('memory-day'));
        const imageFile = formData.get('memory-image');
